...
// @input int count
function onTrigger(sourceTap) {
    var osType = global.deviceInfoSystem.getOS();
    var isDekstop = (osType == OS.Windows || osType == OS.MacOS);
    script.count += 1
    
    if (script.count > 4 && isDekstop == true){
        script.count = 1
    }
    else if(script.count > 2 && isDekstop == false){
        script.count = 1
    }
    ...
    else if (script.count == 2){
        script.textPhoneType.text = "SOURCE ANDROID";
        if (isDekstop == false){
            script.count = 0;
        }
    }
    else if(isDekstop == true && script.count == 3){
        script.textPhoneType.text = "SOURCE WINDOWS";
    }
    else if(isDekstop == true && script.count == 4){

...
setupTrigger();
// @input Component.Text textPauseTrigger
// @input int counttwo
script.counttwo = 0
function onTrigger(PlayPauseTrigger){
    script.counttwo += 1
    if (script.counttwo > 1){
        script.counttwo = 0;
    }
    if (script.counttwo == 0){
        script.textPauseTrigger.text = "PLAY \u{25BA}";
        global.playpauseMode = false
    }
    else if (script.counttwo == 1){
        global.playpauseMode = true;
        script.textPauseTrigger.text = "PAUSE \u{25EB}";
    }
}
